...
class BaseConfig:
    ...
    # User token settings
    REFRESH_TOKEN_TIMEOUT = int(os.environ.get(
        'REFRESH_TOKEN_TIMEOUT', 30))  # this is in days
    AUTH_TOKEN_TIMEOUT = int(os.environ.get(
        'AUTH_TOKEN_TIMEOUT', 30))  # this is in minutes
